...
description: Bounded local implementer, reviewer, fixer, and re-review workflow. Internal building block for autonomous-task; it does not commit, push, create a PR, or merge.
---
