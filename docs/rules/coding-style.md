...
needed, keep the resulting edits within the task's scope.
...
- Keep boundary I/O separate from calculations when practical.
- Do not create generic layers or a catch-all utility module speculatively.
- Follow `ARCHITECTURE.md`, `docs/rules/architecture.md`, and Accepted ADRs.
